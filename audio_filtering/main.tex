...
\newcommand{\system}[1]{\textbf{#1}} % Define \system to make text bold, for example
...
\title{}
\author{EE23BTECH11066 -  Y.Amarnath.Karthik \par Audio Filtering
}
\maketitle
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/audio.wav
\end{lstlisting}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{audio_filtering (1)/figs/original.png}
    \caption{Spectrogram of original sound}
    \label{fig:original.png}
\end{figure}
\item
\label{prob:output}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{audio_filtering (1)/figs/reduced_noise.png}
    \caption{Spectrogram with reduced noise}
    \label{fig:reduced noise}
\end{figure}
\end{enumerate}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/3.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/3.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/5.2.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
%
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/6_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/6.4.py 
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/6.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\noindent Answer the following questions by looking at the python code in Problem 
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/7.1.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{audio_filtering (1)/figs/plot.png}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/7.2.py
\end{lstlisting}
\input{tables/audio_filter_tab}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{audio_filtering (1)/figs/stemplot.png}
...
\begin{lstlisting}
https://github.com/AmarnathKarthik286/AUDIO_FILTERING/blob/main/audio_filtering/codes/Filter_response.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{audio_filtering (1)/figs/Filter_Response.png}
